...
v_list$mackerel <- c("SST", "SSS", "windfarms", "max_SSV", "EuphD", "depth")
v_list$twaite_shad <- c("Quarter_sin", "Quarter_cos", "SST", "SSS", "windfarms", "seabed_energy", "seabed_substrate", "depth") 
v_list$seabass <- c("SST", "SSS", "windfarms", "depth")
...
sum_all[match(sum_all$variable, species$simple),]


setwd("/data/home/innovauth/ward.standaert@vliz.be/OUTPUT/reduced_data_model/adult/final_model/evaluation/")
...
morans_I_list[[1]]   
#Before filtering:          Moran's I value of 0.04, expected -0.001: significant
#After sp & geo filtering:  Moran's I value of 0.06, expected -0.0009; significant
morans_I_list[[2]]   
#Before filtering:          Moran's I value of 0.07, expected -0.00009; significant
#After sp & geo filtering:  Moran's I value of 0.05, expected -0.0009; significant
morans_I_list[[3]]   
#Before filtering:          Moran's I value of 0.09, expected -0.0003; significant
#After sp & geo filtering:  Moran's I value of 0.04, expected -0.0009; significant
morans_I_list[[4]]   
#Before filtering:          Moran's I value of 0.21, expected -0.0002; significant
#After sp & geo filtering:  Moran's I value of 0.10, expected -0.0009; significant
...
morans_I_list[[1]]   
#Before filtering:          Moran's I value of 0.22, expected -0.00008; significant
...
#todo After sp & geo filtering:  Moran's I value of 0.21, expected -0.01; significant
morans_I_list[[3]]   
...
#todo After sp & geo filtering:  Moran's I value of 0.24, expected -0.01; significant
...
for (s in 1:nrow(species)) {
  png(paste0("BPNS_",species$simple[s], "_var_imp_response_curves.png"), width = 13, 
...
for (s in 1:nrow(species)) {
  ...
  for(i in 1:nlayers(pr_geo_bpns)) {
    writeRaster(pr_geo_bpns[[i]], paste0("output_rasters_BPNS/BPNS_",species$simple[s],"_adult_",i,".tif"))
  }
  
  #save picture
  png(paste0("BPNS_",species$simple[s], "_prediction.png"), width = 8, height = 9, res = 100, units = 'in')
