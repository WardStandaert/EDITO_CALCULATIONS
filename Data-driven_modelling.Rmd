...
The default output only shows the Area Under the Curve of the Receiver Operating Characteristic plot (AUC) metric. We also want to calculate the True Skill Statistic (TSS), the True Positive Rate (TPR) and the True Negative Rate (TNR) to get a more complete image of the model performance [@grimmett2020presence].
...
Maps are derived from the .zarr files in the datalake at a given time and between a set of longitude and latitudes.
