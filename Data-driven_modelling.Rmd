...
We start with `r nrow(df_occs)` occurrences.
```{r step 2}
df_occs <- df_occs %>%
...
To deal with sampling bias, a spatial filtering technique was applied. 
Here we thinned the occurrences so that each pair of occurrences hass a minimum distance of 10 nautical miles or 18.52 km.
This distance is the recommended distance between valid hauls in the DATRAS traxwl surveys. 
